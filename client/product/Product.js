              ...
              <Card className={classes.card}>
                ...
                <div className={classes.flex}>
                  ...
                  <div style={{width: '50%', margin: '0 20px'}}>
                    <span style={{marginTop: '0'}} className={classes.price}>Rs. {this.state.product.price}</span>
                    <span className={classes.price}>Phone #: {this.state.product.phone_no}</span>
                    <span className={classes.price}>City: {this.state.product.city}</span><br></br>
                    
                  </div> 
                </div>
                <div style={{width: '100%', margin: '0 30px'}}>
                  ...
                  <Link to={'/shops/'+this.state.product.shop._id} className={classes.link}>
                    ...
                    <Typography component="p" type="subheading" className={classes.subheading}>{this.state.product.description}</Typography>
                </div>
              </Card>
            </Grid>
