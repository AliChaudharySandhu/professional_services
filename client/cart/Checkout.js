...
class Checkout extends Component {
  ...
  componentDidMount = () => {
    ...
    checkoutDetails.customer_phone_no = user.phone_no
    ...
    return (
      <div classes={classes.root}>
        <Card className={classes.card}>
          ...
          <TextField id="phone_no" type="phone_no" label="Phone No" className={classes.textField} value={this.state.checkoutDetails.customer_phone_no} onChange={this.handleCustomerChange('customer_phone_no')} margin="normal"/><br/>
