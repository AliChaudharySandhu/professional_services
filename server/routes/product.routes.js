...
router.route('/api/product/status/:productId')
.put(productCtrl.updateProductStatus)
...
router.route('/api/list/cities')
  .get(productCtrl.listCities)

router.route('/api/products')
  .get(productCtrl.list)

router.route('/api/admin/products')
  .get(productCtrl.listAdmin)
